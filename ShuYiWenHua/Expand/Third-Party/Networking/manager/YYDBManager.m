...
static YYDBManager *dbManager = nil;
...
- (NSManagedObjectModel *)managedObjectModel
{
    ...
    NSURL *modelURL = [[NSBundle mainBundle] URLForResource:@"MeatDB" withExtension:@"momd"];
...
- (NSPersistentStoreCoordinator *)persistentStoreCoordinator
{
    ...
    NSURL *storeURL = [[self applicationDocumentsDirectory] URLByAppendingPathComponent:@"MeatDB.sqlite"];
...
-(NSManagedObject *)createObjectWithEntityName:(NSString *)entityName{
    ...
    @catch (NSException *exception) {
        NSLog(@"Create NSManagedObject exception : %@", [exception description]);
        return nil;
    }
}
...
-(NSArray*)fetchObjectsWithEntityName:(NSString *)entityName filter:(NSPredicate *)filter sort:(NSArray *)descriptors pageCount:(int)count index:(int)index{
    ...
    @catch (NSException *exception) {
        result = nil;
        NSLog(@"Fetch objects exception : %@",[exception description]);
    }
...
-(void)deleteObjectsWithEntityName:(NSString *)entityName filter:(NSPredicate *)filter{
    ...
    @catch (NSException *exception) {
        NSLog(@"Delete object exception : %@",[exception description]);
    }
}
...
-(void)updateObjectsWithEntityName:(NSString *)entityName infor:(NSDictionary *)infor filter:(NSPredicate *)filter{
    ...
    @catch (NSException *exception) {
        NSLog(@"Update object exception : %@", [exception description]);
    }
}
...
-(NSUInteger)getRecordCountWithEntityName:(NSString *)entityName filter:(NSPredicate *)filter{
    ...
    @catch (NSException *exception) {
        NSLog(@"get record count exception:%@", exception);
    }
